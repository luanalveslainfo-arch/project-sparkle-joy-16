  ...
  return (
    ...
    >
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-black/90 border-b border-white/10 p-4 flex items-center justify-between">
        ...
        <h1 className="text-3xl" style={{ fontFamily: "'UnifrakturMaguntia', serif" }}>ARCANE</h1>
        <div className="flex items-center gap-4 text-sm">
      ...
      <section className="relative h-screen flex items-center justify-center pt-20">
        ...
        <h2 className="relative text-6xl md:text-9xl uppercase tracking-widest text-center" style={{ fontFamily: "'UnifrakturMaguntia', serif" }}>
      ...
      <main className="container mx-auto px-4 py-16">
        <h3 className="text-3xl uppercase mb-12 text-center border-b border-red-900 pb-4" style={{ fontFamily: "'UnifrakturMaguntia', serif" }}>Drop Arcano</h3>
      ...
      <footer className="bg-zinc-950 border-t border-white/10 py-16">
        <div className="container mx-auto px-4 grid md:grid-cols-3 gap-8">
          <div>
            <h4 className="text-xl mb-4" style={{ fontFamily: "'UnifrakturMaguntia', serif" }}>NEWSLETTER</h4>
          ...
          <div className="flex gap-4 items-end">
            <Instagram className="cursor-pointer hover:text-red-900" />
            <Twitter className="cursor-pointer hover:text-red-900" />
            <Mail className="cursor-pointer hover:text-red-900" />
          </div>
